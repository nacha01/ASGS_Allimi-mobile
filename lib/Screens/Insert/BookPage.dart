...
class BookPage extends StatelessWidget {
  ...
  FirebaseUser user;
  BookPage({Key key, @required this.user, this.number, this.Book_data})
      : super(key: key);
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Text(
              '판매가: ${numberWithComma(data['value'])}',
        ...
        child: Row(
          ...
          children: <Widget>[
            MaterialButton(
                ...
                onPressed: () async {},
                child: Row(
                  children: [Icon(Icons.info), Text(' 상세정보')],
                )),
            MaterialButton(
                minWidth: MediaQuery.of(context).size.width / 3,
                color: Colors.blue,
                ...
                child: Row(
                  children: [Icon(Icons.shopping_cart), Text(' 바로구매')],
                )),
          ],
        ),
      ),
